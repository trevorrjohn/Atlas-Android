...
public class AtlasHistoricSyncLayout extends SwipeRefreshLayout implements LayerChangeEventListener.BackgroundThread.Weak {
    private LayerClient mLayerClient;
    private Conversation mConversation;
    private int mSyncAmount = 32;

    public AtlasHistoricSyncLayout(Context context) {
        super(context);
    }

    public AtlasHistoricSyncLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AtlasHistoricSyncLayout init(LayerClient layerClient) {
     ...
     */
    public AtlasHistoricSyncLayout setConversation(Conversation conversation) {
     ...
     * @return This `AtlasMessagesSwipeSyncLayout`.
     */
    private AtlasHistoricSyncLayout refresh() {
        post(new Runnable() {
            @Override
            public void run() {
